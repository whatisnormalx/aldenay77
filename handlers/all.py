...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/FSFFF")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/FSFFF")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/FSFFF")]])
